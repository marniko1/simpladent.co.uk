...
<div class="section" id="aboutSection_2">
	...
	<div class="section" id="aboutSection_4">
        ...
        <div class="note">
            <p>The treatment technology with the Strategic Implant® is at the moment not available in the UK. Patients receive help for a trip to Simpladent Montenegro.</p>
            <p>Simpladent clinics use patented and unique implants and technology, which is not available outside of Simpladent clinics.</p>
        </div>
